# EPIC-014 — Model Timestamp Portability
...
The EPIC-004 completion report identified literal `server_default="now()"` values in several SQLAlchemy models. This is dialect-fragile and prevents clean SQLite fixture use for affected models.
...
- EPIC-013 should be completed before this EPIC unless ChatGPT explicitly changes the ordering.
...
- `docs/epics/EPIC-014-model-timestamp-portability.md` — this completion report.
