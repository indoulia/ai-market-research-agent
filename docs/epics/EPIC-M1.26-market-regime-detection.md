...
autonomous/epic-m1-26, branched cleanly from `main` (all three declared dependencies -- M1.15, M1.21, M1.24 -- are already merged).
...
- `docs/epics/EPIC-M1.26-market-regime-detection.md` — this completion report.
...
- [x] No future data is used (inherits M1.12's own point-in-time-safe feature computation).
