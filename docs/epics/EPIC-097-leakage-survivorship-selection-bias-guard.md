# EPIC-097 — Leakage, Survivorship & Selection-Bias Guard
...
## Dependencies
Previous: EPIC-073, EPIC-074, EPIC-095, EPIC-096.
Next: EPIC-098.
...
autonomous/epic-m1-97, branched cleanly from `main` (all four declared dependencies -- EPIC-073, EPIC-074, EPIC-095, EPIC-096 -- are already merged).

### Objective

Make look-ahead, survivorship and selection bias detectable and blocking for training, replay and evaluation workflows -- a different consumer than EPIC-082's live recommendation-publication gate.
...
- `docs/epics/EPIC-097-leakage-survivorship-selection-bias-guard.md` — this completion report.
...
- [x] Historical evaluation uses the correct point-in-time universe (the new universe-membership check; composes EPIC-096's confirmation that survivorship bias is already structurally absent).
