# EPIC-168 — Kubernetes-Native Ingest & Discovery-Scan Execution

**Track:** M1 / Operational Discovery
**Status:** DONE
**Execution Status:** DONE (merged via PR #275)
**Priority:** P1

## Objective

Close the same operational gap EPIC-167 closed for Docker Compose, but for the
...
EPIC-167 added `scripts/ingest_market_history.py` and
...
- Changing the discovery/scoring/signal-provider logic itself (EPIC-167's scope).
...
- EPIC-167 (`scripts/ingest_market_history.py`, `scripts/run_discovery_scan.py`,
...
- **No fake intelligence / no fabricated data:** identical to EPIC-167 — empty or
