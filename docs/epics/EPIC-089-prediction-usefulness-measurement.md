# EPIC-089 — Prediction Usefulness Measurement
...
## Dependencies
Previous: EPIC-042, EPIC-079, EPIC-080, EPIC-086.
Next: EPIC-118.
...
autonomous/epic-m1-86, branched cleanly from `main` (the declared dependencies -- EPIC-042, EPIC-079, EPIC-080, EPIC-086 -- are already merged).
...
- `docs/epics/EPIC-089-prediction-usefulness-measurement.md` — this completion report.
...
- [x] Benchmark-relative performance is available (via composition with EPIC-086's already-built report; not duplicated here).
...
- [x] Metrics are segmented by horizon and regime (`compute_horizon_usefulness_report` per `(model_version, horizon_days)`; regime segmentation available via EPIC-084's own existing segment machinery).
