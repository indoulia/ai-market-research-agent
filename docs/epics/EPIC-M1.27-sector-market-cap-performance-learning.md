...
autonomous/epic-m1-27, branched cleanly from `main` (all three declared dependencies -- M1.16, M1.21, M1.26 -- are already merged).
...
- `docs/epics/EPIC-M1.27-sector-market-cap-performance-learning.md` — this completion report.
